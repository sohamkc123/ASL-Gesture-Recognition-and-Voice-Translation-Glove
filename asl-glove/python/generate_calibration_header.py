...
OUT_DIR = os.path.join(os.path.dirname(__file__), "..", "esp32", "model deploy", "model_deploy")
...
def main():
    ...
    print("Copy/keep this in esp32/model deploy/model_deploy/ alongside model_data.h before flashing.")
