...
# Handle class imbalance by weighting rare letters more during loss computation.
...
class_weight = {int(c): float(w) for c, w in zip(train_classes, class_weights_arr)}
...
print("======================================")
print("\nNext steps:")
print(f"1. Copy {header_path} into esp32/model deploy/model_deploy/")
print("2. Make sure esp32/model deploy/model_deploy/calibration.h is up to date")
